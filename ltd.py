...
"""
Code by FarisYang (https://github.com/FarisYang/LTTB-LTD-py/tree/main), slightly adapted
"""
...
def ltd(data, n_out):
    ...
    # transform 1D Time Series to 2D requirement
    indices = np.arange(0, len(data))
    data = np.column_stack((indices, data))
	...
	# return only indizes of original ts
